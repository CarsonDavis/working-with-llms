...
<span class="newthought">An agent has no idea</span> what your project is doing, who it is for, or what it should accomplish. If you ask it to go do a task blind, it will sometimes do it in a way that defeats the entire purpose of your repo.
...
<figure class="pull"><blockquote>None of these are the model writing bad code. The code is probably fine.</blockquote></figure>

## How to write one

You don't have to labor over this. The fastest way is to word-vomit it: the people who actually hold the vision talk for ten or fifteen minutes about everything that matters, into speech-to-text, and let the LLM organize it into a draft.[^related-repos]
...
[^related-repos]: Point it at related repos or existing material if that helps.
