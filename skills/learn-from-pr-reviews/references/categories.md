...
pipeline in `standard-artifacts/review.md` so the distilled draft drops straight
into that framework. Pick the single best fit; use `emergent` only when none fit.
