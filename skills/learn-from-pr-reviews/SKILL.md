...
review-agent prompt. Built to seed the §3 "Review" core document
(`standard-artifacts/review.md`).
...
- A review-agent prompt skeleton aligned to the `standard-artifacts/review.md`
  pipeline.
