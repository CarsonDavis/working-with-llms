...
9. **Write to disk** at `docs/issues/YYYY-MM-DD-<topic>.md` as an editing buffer, and tell the human to edit it directly.
...
```bash
gh issue create --repo <owner/repo> --title "<title>" --body-file docs/issues/<file>.md
```
