...
- As an custom review on the project, run on the diff before human review. This is the part you grow over time.
...
Review is the arm of the broader improvement loop (see the README) with the most tooling behind it: every cycle, what your reviewers catch gets written back in here so it isn't missed again.
